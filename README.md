...
- Imports Enterprise Authentication & NetLog Inspector exports, Firefox SAML-tracer JSON exports, raw entry arrays, and browser HAR files. SAML-tracer decoded XML is retained even when the exported form parameter was redacted.
