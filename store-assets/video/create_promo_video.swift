...
let scenes = [
    ...
    Scene(start: 6, end: 14, eyebrow: "COMPLETE SSO TRAFFIC", title: "Follow every redirect and exchange", subtitle: "OAM, SAML, Okta, Microsoft Entra, OAuth/OIDC, Kerberos, NTLM, and X.509 in one trace.", image: "store-assets/screenshots/01-complete-sso-traffic.png", accent: NSColor(calibratedRed: 0.25, green: 0.85, blue: 0.67, alpha: 1)),
    ...
    Scene(start: 47, end: 54, eyebrow: "OPEN SOURCE · LOCAL ANALYSIS", title: "Troubleshoot SSO with confidence", subtitle: "OAM · SAML · OIDC · Okta · Entra · Kerberos/WNA · X.509", image: nil, accent: NSColor(calibratedRed: 0.31, green: 0.78, blue: 0.96, alpha: 1))
]
