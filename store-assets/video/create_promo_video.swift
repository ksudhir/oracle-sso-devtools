...
let scenes = [
    ...
    Scene(start: 47, end: 54, eyebrow: "OPEN SOURCE · LOCAL ANALYSIS", title: "Troubleshoot SSO with confidence", subtitle: "OAM · SAML · OAuth/OIDC · Kerberos/WNA · NTLM · X.509", image: nil, accent: NSColor(calibratedRed: 0.31, green: 0.78, blue: 0.96, alpha: 1))
]
