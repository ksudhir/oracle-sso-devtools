# Enterprise Authentication Flow Inspector for Microsoft Edge
...
6. Open Microsoft Edge DevTools and select **Auth Flow Inspector**. Use the Activity Bar's **More tools** menu if the panel is not visible.
...
5. Import the JSON file through **Auth Flow Inspector > Import File**.
