...
4. Use the category filters, source navigator, diagnostic findings, and expandable event timeline.

The sample includes URL, proxy, DNS, socket, TLS certificate, and authentication-challenge events. It contains no real credentials, tokens, hosts, or user information.
