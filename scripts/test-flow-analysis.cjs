...
assert.match(manifest.description, /Troubleshoot and correlate authentication flows/u);
assert.match(manifest.description, /SAML, OAuth\/OIDC, OAM\/WebGate, Kerberos\/WNA, NTLM, X\.509, Okta, and Entra ID/u);
